...
class Character extends FNFSprite
{
	...
	public function setCharacter(x:Float, y:Float, character:String)
	{
		...
		switch (curCharacter)
		{
			...
			case 'chris':
				tex = Paths.getSparrowAtlas('characters/chris');
				frames = tex;
				animation.addByPrefix('idle', 'chrisidle', 24, false);
				animation.addByPrefix('singUP', 'chrisup', 24);
				animation.addByPrefix('singRIGHT', 'chrisright', 24);
				animation.addByPrefix('singDOWN', 'chrisdown', 24);
				animation.addByPrefix('singLEFT', 'chrisleft', 24);
